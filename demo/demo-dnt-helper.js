...
var dntHelper = function (dnt, ua) {
    ...
    function showInDemo() {
        var dntEnabled = 'Enabled! :)';
        var dntDisabled = 'Disabled :(';
        var dntValue = document.getElementById('dnt-value');
        if (dntStatus === 'Enabled') {
    ...
    // This function call is for demo purposes only
    showInDemo();
